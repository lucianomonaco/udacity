...
def column_to_list(data, index):
    ...
    Argumentos:
      ...
      param2: indice.
    Retorna:
      Uma lista de valores da coluna especifica.
...
def count_gender(data_list):
    ...
    Argumentos:
      param1: lista.
    Retorna:
      Uma lista com [count_male, count_female] (exemplo: [10, 15] significa 10 Masculinos, 15 Femininos).
...
def count_user_type(data_list):
    """
    Função para criar um gráfico similar para user_types.
    Argumentos:
      param1: lista.
    Retorna:
      Exibe gráfico.
...
answer = "Porque existem 316.868 linhas na data_list sem informação na coluna gender."
...
mean_trip = round(sum(trip_duration_list) / len(trip_duration_list), 2)
...
def count_items(column_list):
    """
    Função para contar categorias de dados.
    Argumentos:
      param1: categoria.
    Retorna:
      lista com as categorias e quantidade de itens.
